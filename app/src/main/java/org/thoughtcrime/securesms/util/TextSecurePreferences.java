...
public class TextSecurePreferences {
  ...
  public static boolean isPasswordDisabled(Context context) {
    return getBooleanPreference(context, DISABLE_PASSPHRASE_PREF, true); // JW: default true
  }
  ...
  public static void setOverrideInternalUser(Context context, boolean value) {
    setBooleanPreference(context, OVERRIDE_INTERNAL_USER, value);
  }
