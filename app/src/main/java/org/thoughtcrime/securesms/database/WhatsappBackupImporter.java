...
import static org.thoughtcrime.securesms.database.MmsTable.MESSAGE_BOX;
import static org.thoughtcrime.securesms.database.MmsTable.MESSAGE_TYPE;
import static org.thoughtcrime.securesms.database.MmsTable.PART_COUNT;
import static org.thoughtcrime.securesms.database.MmsTable.STATUS;
...
public class WhatsappBackupImporter {
    ...
    private static void insertMms(MmsTable mmsDb, AttachmentTable attachmentDb, WhatsappBackup.WhatsappBackupItem item, Recipient recipient, long threadId, List<Attachment> attachments) throws MmsException {
        ...
        contentValues.put(STATUS, MmsTable.Status.DOWNLOAD_INITIALIZED);
